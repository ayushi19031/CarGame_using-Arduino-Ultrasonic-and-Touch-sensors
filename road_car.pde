...
void draw(){
 ...
 //println(d);
  ...
  fill(0);
   textSize(50);
  text("TRAFFIC TROUBLE.",width/2,height/2,350,602);
  textSize(50);
  text("Press 2.",width/2,height/2);
  }
  if(r==1){
    gameover();
  }
...
void serialEvent(Serial bt){
  ...
  try{
   ...
   if(bt.available()>0){ 
     switch(bt.readString()){
     case("1"):{y-=50;a.play();break;}
     case("2"):{y+=50;a.play();break;}
     case("3"):{x+=20;a.play();break;}
     case("4"):{x-=20;a.play();break;}
     case("5"):{r=2;
scr=0;
reset();
minim.stop();
...
text("Not good",350,100);
  ...
  text(scr,350,300);
textSize(10);
  text("PRESS 2 TO RESTART",350,350);
  textSize(30);
...
if(scr>=50 && scr<=199){
 ...
 image(car,350,462);
textSize(30);
text("You got a GRADE 1 licence !",350,270);
  text("Your score :",350,320);
  text(scr,350,370);
textSize(10);
  text("PRESS 2 TO RESTART",350,400);
  bt.write('9');
...
if(scr>199){
 ...
 image(car,350,462);
textSize(30);
text("You got a GRADE 2 licence !",350,270);
  text("Your score :",350,320);
  text(scr,350,370);
textSize(10);
  text("PRESS 2 TO RESTART",350,400);
